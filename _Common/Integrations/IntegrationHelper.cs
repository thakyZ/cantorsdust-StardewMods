...
#region Public methods
    ...
    /// <param name="monitor">Encapsulates monitoring and logging.</param>
    /// <returns>Returns the API interface if valid, else null.</returns>
    public static IUIInfoSuite2Api? GetUIInfoSuite2(IModRegistry modRegistry, IMonitor monitor)
    {
        return IntegrationHelper.GetValidatedApi<IUIInfoSuite2Api>(
            label: "UI Info Suite 2",
            modId: "Annosz.UiInfoSuite2",
            minVersion: "2.3.5",
            modRegistry: modRegistry,
            monitor: monitor);
    }

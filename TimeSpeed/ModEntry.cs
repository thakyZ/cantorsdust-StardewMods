...
#region Properties
    ...
    private bool _isTimeFrozen => this.ManualFreeze == true || (this.AutoFreeze != AutoFreezeReason.None && this.ManualFreeze != false);

    internal static bool IsTimeFrozen => ModEntry._instance?._isTimeFrozen == true;
...
#region Public methods
    ...
    public override void Entry(IModHelper helper) {
        ...
        this.InitializeNewStuff(helper);
...
#region Methods
    ...
    private void ChangeTickInterval(bool increase)
    {
        ...
        // log change
        this.Notifier.QuickNotify(I18n.Message_SpeedChanged(seconds: this.TickInterval / 1000), true);
    ...
    private void ToggleFreeze()
    {
        if (!this._isTimeFrozen)
        {
            ...
            this.Notifier.QuickNotify(I18n.Message_TimeStopped(), true);
            this.Monitor.Log("Time is frozen globally.", LogLevel.Info);
        }
        else
        {
            this.UpdateTimeFreeze(manualOverride: false);
            this.Notifier.QuickNotify(I18n.Message_TimeResumed(), true);
    ...
    {
        bool wasFrozen = this._isTimeFrozen;
        this.UpdateTimeFreeze();

        if (wasFrozen || !this._isTimeFrozen) return;

        this.Notifier.ShortNotify(I18n.Message_OnTimeChange_TimeStopped(), true);
    ...
    //                 this.Notifier.ShortNotify(I18n.Message_OnLocationChange_TimeStoppedGlobally(), true);
    //                 break;
    //
    //             case AutoFreezeReason.FrozenForLocation when this.IsTimeFrozen:
    //                 this.Notifier.ShortNotify(I18n.Message_OnLocationChange_TimeStoppedHere(), true);
    //                 break;
    //
    //             default:
    //                 this.Notifier.ShortNotify(I18n.Message_OnLocationChange_TimeSpeedHere(seconds: this.TickInterval / 1000), true);
    //                 break;
    //         }
    //     }
    //}

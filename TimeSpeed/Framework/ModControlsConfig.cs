...
#region Accessors
    ...
    public KeybindList FreezeTime { get; set; } = new KeybindList(SButton.N);
    ...
    public KeybindList IncreaseTickInterval { get; set; } = new KeybindList(SButton.OemPeriod);
    ...
    public KeybindList DecreaseTickInterval { get; set; } = new KeybindList(SButton.OemComma);
    ...
    public KeybindList ReloadConfig { get; set; } = new KeybindList(SButton.B);
#endregion
}
